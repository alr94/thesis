...
% In addition, due to uncertainty surrounding the ordering of neutrino
% masses, a new parameter 
% \begin{equation}
	% \label{eqn:delta_m}
	% \Delta m^2 = m_3^2 - (m_1^2 + m_2^2)/ 2 = \Delta m^2_{32} + \frac{\Delta m^2_{21}}{2}
% \end{equation}
% is often defined which represents the dominant mass squared difference in long 
% baseline neutrino oscillations. Because $\Delta m^2_{32} \gg \Delta m^2_{21}$
% this new parameter is a good approximation to $\Delta m^2_{32}$. 

% Figure 
% \ref{fig:delm_sin23} shows the allowed regions in 
% $\Delta m^2$--$\sin^2(\theta_{23})$ space from fits to neutrino oscillation data 
% \cite{Capozzi:2016rtj}.
