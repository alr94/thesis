...
\end{align}
As such neutrino oscillation experiments are only sensitive to the differences
in mass squared between the neutrino mass eigenstates, and not the absolute
masses of the states. 

In the widely accepted three neutrino model of neutrino oscillation, the PMNS 
matrix is often parametrised in terms of three mixing angles \(\theta_{12}\), 
