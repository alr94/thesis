...
implications in both particle physics and cosmology: 
\begin{itemize}
...
provide valuable input to studies of supernova burst neutrinos in LArTPC 
detectors.
...
results for physics in LArTPC detectors.
