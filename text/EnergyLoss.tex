...
electron is accompanied by the incoming Muon in the image, which cannot be 
separated in the ionisation signal due to the slow drift of the ionisation.
...
created by the ionisation caused by the Compton scattered electron of electron 
positron pair.
...
difference in the $dE/dx$ in the first few cm of these showers which can allow
for electron and photon showers to be distinguished \cite{Acciarri:2016sli}. A 
