...
important features of the energy loss for muons, electrons, and photons. The
discussion here closely follows the discussion in \cite{PhysRevD.98.030001}.
...
above, in equation \ref{eq:rossi}\cite{PhysRevD.98.030001}. The value of the 
critical energy has important implications for reconstruction algorithms, 
because different approaches are often required above and below the critical 
energy. 
...
photons has two main components for photons in the MeV range, which are due to 
