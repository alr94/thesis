...
ordering, based on the Nu--Fit global three neutrino oscillation analysis 
...
\cite{Abe:2013sxa}, and RENO \cite{Ahn:2012nd} have made precise measurements of
$\theta_{13}$, as well as some long baseline oscillation experiments, such as 
T2K and \nova. The Nu--Fit three neutrino global fit to the reactor data gives,
\begin{align*}
...
\citetemp{PhysRevD.96.092006,PhysRevLett.123.151803}. When these results are 
