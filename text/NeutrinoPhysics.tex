...
While it couldn't pin down the exact cause of the solar neutrino problem, the
...
baseline. In the ultra--relativistic limit, we can approximate \({t \simeq 
L}\) in natural units. As a result, Equation \ref{eqn:p_osc_u} can be 
approximated as:
\begin{equation*}
...
The core--collapse comes to a sudden halt about 1 second after it began, when 
...
still unknown. Studies have shown that the impact of spherically 
asymmetries might play an important role in allowing the burst to take 
...
low. This region is called the neutrinosphere, it depends on flavour, and it is
different for neutrinos and anti--neutrinos. These differences result in 
...
IMB, and Baksan. These events were primarily produced by two types of 
...
challenges involved in this measurement as a result of the challendes involved
