...
\mccorrect{TODO. I'd like to replicate Francesca's study here and show a
comparison of the fraction of different particle species identified as track's
and showers by Pandora and the CNN.}
...
The shower score distribution for beam pions is shown in Figure
\ref{fig:beam_pi_cnn}. TODO.
...
\begin{figure}
	...
	\caption
	[Shower classifier score for hits from beam pions.]
	{Shower classifier score for hits from beam pions.}
...
\begin{figure}
	...
	\caption
	[Shower classifier score for hits from beam protons.]
	{Shower classifier score for hits from beam protons.}
...
\begin{figure}
	...
	\caption
	[Shower classifier score for hits from beam electrons.]
	{Shower classifier score for hits from beam electrons.}
...
\begin{figure}
	% TODO: make me
	\centering
	\includegraphics[width=\textwidth]{figures/hit_cnn_muon.pdf}
	\caption
	[Shower classifier score for hits from cosmic--ray muons.]
	{Shower classifier score for hits from cosmic--ray muons.}
