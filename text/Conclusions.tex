...
oscillation experiment that aims to make precision measurements of neutrino
...
The data used in this thesis was collected using the \protodune{} detector
during a beam run in late 2018. The online monitoring system used during this
time was developed and maintained by the author, who was also the on call expert
for the system. Many components of the OM system, particularly the data analysis
processes will be adopted and developed for the online data quality monitoring
