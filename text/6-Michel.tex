...
for each hit within the image window, the number of hits included in each image
is shown in figure \ref{fig:n_hits_image} alongside the same distribution for
data. \mccorrect{The peak in hits at 100 corresponds to ... TODO}. The training 
data is split into training, test, and validation sets in the ratio 80:10:10. In
total around 40,000,000 images were generated.
\begin{figure}
	\centering
	% TODO: Make this plot.
	\includegraphics[width=\textwidth, height=0.68\textwidth]{figures/n_hits_image.png}
	\caption
	[Number of hits in image.]
	{Number of hits in image.}
	\label{fig:n_hits_image}
\end{figure}
...
equation is then inverted to give the reconstructed Michel electron energy for a
given reconstructed ionisation energy.
\begin{figure}
	\centering
	% TODO
