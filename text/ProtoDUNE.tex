...
The ARAPUCA is a novel design and only used in a small number of photon detector
...
inside. On one side of the box is the filtering window, and on another a SiPM. 
Incoming ultra--violet photons are shifted to the blue spectrum before 
