...
\begin{figure}
	...
	components labelled on the image. Figure from \cite{Abi:2017aow}.}
...
minute.  During this time each set of plots will have contain data from 10 
events, however, the Event Displays and TPC FFTs each contain data from one 
event.
