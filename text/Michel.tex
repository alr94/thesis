...
and to suggest possible mitigation strategies for any similar algorithms, which
...
These effects could be mitigated with a network which has been trained on a
variety of models, which could be generated with a generative adversarial
network, as discussed in Section \ref{hittag_syst}.
