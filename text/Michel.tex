...
The fractional energy difference between the reconstructed ionisation energy and
the true ionisation energy for the case of perfect hit tagging is shown in
Figure \ref{fig:michel_hit_res}.
\begin{figure}
	\centering
...
energy resolution for reconstructed hits contributes around 8\% to the Michel 
